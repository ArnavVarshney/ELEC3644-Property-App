...
struct Location: Identifiable, Hashable, Codable {
  ...
  static let districts: [String: [String]] = [
    ...
    "New Territories": [
      "Kwai Tsing", "Tsuen Wan", "Tuen Mun", "Yuen Long", "North", "Tai Po", "Sha Tin", "Sai Kung",
      "Islands",
    ],
  ]
  ...
  static let subDistricts: [String: [String]] = [
    ...
    "Southern": [
      "Pok Fu Lam", "Aberdeen", "Ap Lei Chau", "Wong Chuk Hang", "Shouson Hill", "Repulse Bay",
    ...
    "Sham Shui Po": [
      "Mei Foo", "Lai Chi Kok", "Cheung Sha Wan", "Sham Shui Po", "Shek Kip Mei", "Yau Yat Tsuen",
      "Tai Wo Ping", "Stonecutters Island",
    ],
    "Kowloon City": [
      "Hung Hom", "To Kwa Wan", "Ma Tau Kok", "Ma Tau Wai", "Kai Tak", "Kowloon City", "Ho Man Tin",
    ...
    "Kwun Tong": [
      "Ping Shek", "Kowloon Bay", "Ngau Tau Kok", "Jordan Valley", "Kwun Tong", "Sau Mau Ping",
    ...
    "Sai Kung": [
      "Clear Water Bay", "Sai Kung", "Tai Mong Tsai", "Tseung Kwan O", "Hang Hau", "Tiu Keng Leng",
      "Ma Yau Tong",
    ],
    "Islands": [
