...
struct PropertyDetailMapView: View {
    ...
    var body: some View {
        VStack {
            ...
            PropertyDetailNearestListView(title: "Restaurants", category: .restaurant, viewModel: viewModel)
            PropertyDetailNearestListView(title: "Transportations", category: .publicTransport, viewModel: viewModel)
