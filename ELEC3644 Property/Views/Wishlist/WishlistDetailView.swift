            ...
            List{
                ForEach(wishlist.properties.indices, id: \.self) { idx in
                    Button {
                        ...
                        WishlistItemCard(pickedPropertiesIdx:$pickedPropertiesIdx, property: wishlist.properties[idx], picking: state != .view, idx: idx)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .topBarTrailing) {
                    ...
                    Button {
                        ...
                        Image(systemName: "calendar.day.timeline.trailing").foregroundStyle(getCompareColor())
                    }
                }
            }
        ...
        HStack{
            ...
            VStack(){
                if picking{
                    HStack{
                        Spacer()
                        Image(systemName: picked ? "checkmark.circle.fill" : "checkmark.circle").foregroundStyle(picked ? .blue : .black)
                    }
                }
                Spacer()
                HStack{
