        ...
        NavigationStack {
            VStack{
                VStack(alignment: .leading) {
                    ...
                    TextField("", text: $folderName, axis: .vertical).font(.system(size: 15)).multilineTextAlignment(.leading)
                ...
                HStack{
                    Text("\(folderName.replacingOccurrences(of: " ", with: "").count)/\(TEXT_LIMIT) characters")
                        .font(.footnote)
                ...
                HStack {
                    ...
                    .foregroundStyle(folderName.replacingOccurrences(of: " ", with: "").isEmpty ? .gray : .black)
                    ...
                    Button {
                        Task {
                            await userViewModel.postWishlist(property: property, folderName: folderName)
                    ...
                    .background(folderName.replacingOccurrences(of: " ", with: "").isEmpty ? .gray : .black)
...
#Preview {
    CreateWishlistForm(showSheet: .constant(true),property: Mock.Properties[0]).environmentObject(UserViewModel())
}
