        ...
        NavigationStack{
            VStack{
                ...
                Button{
                    ...
                    Text("Create wishlist").padding(.init(top: 0, leading: 100, bottom: 0, trailing: 100))
                }.padding(10)
...
#Preview {
    FavoriteSubmitForm(showPrevSheet: .constant(true), property: Mock.Properties[0]).environmentObject(UserViewModel())
}
